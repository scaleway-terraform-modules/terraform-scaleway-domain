...
| <a name="input_bimi_logo_url"></a> [bimi_logo_url](#input_bimi_logo_url) | URL of the log that should be used for BIMI. The file must be a SVG document and follow [BIMI specifications](https://bimigroup.org/creating-bimi-svg-logo-files/). | `string` | `null` | no |
